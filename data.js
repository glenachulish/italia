      ...
      towns: [
        {
          ...
          food: [
            ...
            {
              name: "Da Franco Ristorante Pizzeria",
              note: "Friend's pick on Via Colleoni — traditional Lombard pasta (casoncelli, foiade) plus wood-fired pizzas and meat dishes, in a stone-walled space or at terrace tables. Ask for an outdoor seat for the view. Book ahead. Site: dafrancobergamo.it.",
              kind: "pasta",
              maps: "Da Franco Ristorante Pizzeria, Via Bartolomeo Colleoni 8, Bergamo",
            },
          ],
          tips: [
            "Funicular up is about €1.50 and a few minutes — worth it in July heat.",
            "Don't leave without trying casoncelli — Bergamo's signature stuffed pasta (butter, sage, pancetta).",
            ...
            "Just wander — it's a stunning upper town and you'll find plenty you like along the way.",
            "Follow the funicular path further up (towards San Vigilio) for more restaurants and things to do.",
            "The natural history museum has some gloriously bad old taxidermy — worth a look for a laugh.",
          ],
        },
        {
          id: "bergamo-bassa",
      ...
      towns: [
        {
          ...
          food: [
            {
              name: "Rugantino",
              note: "Friend's pick — typical Roman food near the centre; the cacio e pepe is the standout. Ask to sit outside for a view of a Roman colonnade.",
              kind: "pasta",
              maps: "Rugantino, Via dei Fabbri 1, Milano",
            },
            {
              name: "Osteria Da Fortunata (Brera)",
              note: "Friend's pick for a real osteria vibe near the Pinacoteca di Brera — fresh pasta made on the spot, to die for. Sit outside if you can.",
              kind: "pasta",
              maps: "Osteria Da Fortunata Brera, Via Fiori Chiari 13, Milano",
            },
            {
              name: "Napoli 1820",
              note: "Friend's pick for proper Neapolitan pizza in a lovely setting on the Naviglio Grande. Sit outside — but bring mosquito spray, the canal-side bites.",
              kind: "pizza",
              maps: "Napoli 1820 Pizzeria, Alzaia Naviglio Grande 62, Milano",
            },
            {
              name: "Kobe Sushi",
              note: "Friend's family spot near Navigli for Milan's all-you-can-eat sushi — a set-price à la carte where you order freely but pay for anything left uneaten. Any well-reviewed sushi here is good value. Note: owners may have changed.",
              kind: "sushi",
              maps: "Kobe Sushi, Corso di Porta Ticinese 60, Milano",
            },
            {
              name: "Ciacco",
              note: "Friend's all-time favourite gelato — 'the best ice cream you'll ever have', near the Duomo on Via Spadari.",
              kind: "gelato",
              maps: "Ciacco, Via Spadari 13, Milano",
            },
            {
              name: "Gelato walking back from Navigli",
              note: "On the walk from Navigli to the metro: plenty of gelato (Amorino is nice) plus Vucciria, a Sicilian-goods shop with incredible stuff — worth a stop.",
              kind: "gelato",
              maps: "Vucciria, Milano",
            },
            {
              name: "Bar Principe (aperitivo)",
              note: "Friend's favourite piazza for a nice aperitivo with lovely views — Piazza Sant'Alessandro.",
              kind: "aperitivo",
              maps: "Bar Principe, Piazza Sant'Alessandro 3, Milano",
            },
            {
              name: "La Rinascente Rooftop (aperitivo)",
              note: "Alternative aperitivo on the top floor of the Rinascente department store — sit outside and you look straight onto the Duomo.",
              kind: "aperitivo",
              maps: "La Rinascente Rooftop, Piazza del Duomo, Milano",
            },
          ],
          tips: [
            "Book Last Supper tickets weeks ahead if you want it — they sell out fast.",
            "Trams 1 and 10 are sightseeing routes in disguise.",
            "Visit the Duomo and just wander — it's a stunning city and you'll keep stumbling on things you like.",
            "All-you-can-eat sushi here isn't a buffet: it's a set-price restaurant where you order what you like but pay for anything you leave uneaten.",
          ],
        },
      ],
    },
